...
class RespondsWithJsonQuotesTest extends TestCase
{
    ...
    private function actual() {
        $author = factory(\App\Author::class)
            ->create(['name' => 'Robert Downey Jr.', 'image' => 'robertdowneyjr-m.jpg']);
        ...
        $author = factory(\App\Author::class)
            ->create(['name' => 'Capt. Jack Sparrow', 'image' => 'captjacksparrow-m.jpg']);
        factory(\App\Quote::class)
            ->create([
        ...
        $author = factory(\App\Author::class)
            ->create(['name' => 'Georges St-Pierre', 'image' => 'georgesstpierre-m.jpg']);
        factory(\App\Quote::class)
            ->create([
